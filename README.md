...
These example are boiler plate that has served jsfX projects in the past. Tailor them at your leisure.
### JavaScript
```javascript
...
preventSelectingIfAlreadySelected
       ...
       Possible values are:
            ...
            true
                  Stops re-selecting the previously selected element only if it has `selectedClass` as a class.
            false 
